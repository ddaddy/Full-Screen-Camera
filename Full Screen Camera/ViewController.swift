...
//                    self.previewLayer.anchorPoint = previewView.bounds.origin
            ...
            case .notAuthorized:
                DispatchQueue.main.async { [unowned self] in
                    ...
                    let alertController = UIAlertController(title: "Cam", message: message, preferredStyle: .alert)
            ...
            case .configurationFailed:
                DispatchQueue.main.async { [unowned self] in
                    ...
                    let alertController = UIAlertController(title: "Configuration failure", message: message, preferredStyle: .alert)
